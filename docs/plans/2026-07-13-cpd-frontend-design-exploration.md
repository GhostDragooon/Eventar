...
**Artifact:** https://claude.ai/code/artifact/7b3633c5-67bb-4942-9727-e1ca21040fdb (private; four surfaces, light + dark, interactive tabs)
...
- **Palette.** Deep pine `--brand #0F6E56` reserved for brand/structure *only* (never a status). Neutrals biased green (`#F1F5F3`). Status ramp kept separate per §7a one-color-one-meaning: verified/compliant green, pending/self-reported amber, blocked/lapsed red. The verified signal always pairs colour with a scan icon (colour-blind safe).
...
1. **Teal vs shipped blue** — confirm at M2 unfreeze; retire the blue token set if teal is locked.
