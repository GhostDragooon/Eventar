...
> **3 new migrations from the second pass not yet pushed to Seoul** — `20260814020000`/`20260814030000`/`20260814040000`; same auto-mode-classifier block, `cd /Users/ivan/Eventar && supabase db push --linked`.
>
