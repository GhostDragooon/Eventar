...
export function ExportAnalyticsCsv({
  ...
  return (
    <button
      type="button"
      onClick={download}
      className="inline-flex items-center gap-xs bg-tertiary text-on-tertiary font-label-md text-label-md rounded-lg py-sm px-lg hover:opacity-90 transition-opacity shrink-0"
    >
