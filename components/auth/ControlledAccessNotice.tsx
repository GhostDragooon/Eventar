    ...
    <section className="rounded-[12px] border border-outline-variant bg-surface-container p-md">
      <div className="flex items-start gap-sm">
        ...
        <div className="space-y-xs">
          <h2 className="font-title-lg text-title-lg text-on-surface">Organizer access only</h2>
          <p className="font-body-md text-body-md text-on-surface-variant">
            Access is limited to authorised organizer records. Signing in does not grant a new role or change an existing permission.
          </p>
